...
client.on('interactionCreate', async (interaction) => {
  ...
  if (commandName === 'pause') return interaction.reply('⏸️ Messo in pausa.') && data.player.pause()
  if (commandName === 'resume') return interaction.reply('▶️ Ripresa la riproduzione.') && data.player.unpause()
  ...
  async function ghGetContents(owner,repo,path,ref) { return ghRequest(`/repos/${owner}/${repo}/contents/${path||''}`, ref?{ref}:{}) }
